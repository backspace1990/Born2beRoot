...
12. Вводим логин и пароль пока единственного пользователя. Для меня - tgrandis. Пароль 111.
13. Должeн загрузиться терминал.
14. В терминале вводим команду lsblk и проверяем что у нас все сходится

![image](https://user-images.githubusercontent.com/58044383/142226866-eb8f6f47-5244-40ac-a29f-d3cad7cf9323.png)42
...
#### 4.	ДОСТУП ЧЕРЕЗ ТЕРМИНАЛ
	...
	тогда на маке в файле /Users/tgrandis/.ssh/known_hosts коментим последине записи наычинающиеся на localhost или 127.0.0.1
...
14) Проверить, что пользователь с именем tgrandis есть и входит в группы sudo и tgrandis42
(у меня не было, поэтому: 
sudo groupadd tgrandis42
sudo usermod -a -G tgrandis42 tgrandis)
...
17) Проверить, что хостнейм - tgrandis42
